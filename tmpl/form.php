	...
	<table id="table_participants" style="width:100%">
		...
		?>
				<tr name="entry">
					...
					<td valign="top"><input type="text" name="users[<?php echo $id ?>][email]"  class="required_email" value="<?php echo esc_attr($user['email']) ?>"/></td>
		...
		<?php else: ?>
			<tr name="entry">
				...
				<td valign="top" style="width:32%"><input type="text" name="users[1][email]" class="required_email"/></td>
		...
		<div id="form_company" <?php echo !empty($_SESSION['FORM']['COMPANY']) ? 'style="display:block"' : '' ?>>
			...
			<table cellpadding="3">
				...
				<tr>
					...
					<td><input type="text" name="company[person_email]" class="required_email" size="30" value="<?php echo esc_attr(@$_SESSION['FORM']['COMPANY']['person_email']) ?>"  /></td>		
				</tr>
				<tr>
			</table>
		<br />
	...
	jQuery(document).ready(function($) {
		...
		$("#button_add").click(function() {
			...
			$('<tr>'
				...
				+ '<td valign="top"><input type="text" name="users['+id+'][email]" class="required_email"/></td>'

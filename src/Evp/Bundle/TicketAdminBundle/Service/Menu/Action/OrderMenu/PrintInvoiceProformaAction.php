<?php
/**
 * Print Proforma invoice for given Order
...
/**
 * Class PrintInvoiceProformaAction
 */
class PrintInvoiceProformaAction extends ActionAbstract implements ActionInterface {

    const ROUTER_NAME = 'evp_print_invoice';

    /**
     * @var string
     */
    protected $actionName = 'print-invoice_proforma';
    ...
    public function buildResponseParameters() {
        ...
        return array(
            ...
            'type' => StrategyInterface::INVOICE_PROFORMA,
        );
    }
}

<?php
/**
 * Resends Proforma invoice for given Order
...
/**
 * Class ResendInvoiceProformaAction
 */
class ResendInvoiceProformaAction extends ActionAbstract implements ActionInterface {
     ...
     * @var string
     */
    protected $actionName = 'resend-invoice_proforma';

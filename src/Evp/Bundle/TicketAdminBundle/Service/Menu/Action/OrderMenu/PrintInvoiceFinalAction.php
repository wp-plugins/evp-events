<?php
/**
 * Prints Final invoice for given Order
...
/**
 * Class PrintInvoiceFinalAction
 */
class PrintInvoiceFinalAction extends ActionAbstract implements ActionInterface {
     ...
     * @var string
     */
    protected $actionName = 'print-invoice_final';
